...
class TestCarePlanOutcomeLinking:
    ...
    def test_activity_with_single_outcome_gevl_relationship(self, converter):
    ...
    def test_activity_with_multiple_outcomes(self, converter):
    ...
    def test_activity_with_no_outcomes(self, converter):
    ...
    def test_multiple_activities_with_different_outcomes(self, converter):
    ...
    def test_outcomes_without_gevl_relationship_not_linked(self, converter):
    ...
    def test_outcome_not_in_outcomes_list_not_linked(self, converter):
    ...
    def test_intervention_without_id_skipped(self, converter):
    ...
    def test_outcome_without_id_not_linked(self, converter):
    ...
    def test_get_entry_id_with_list_of_ids(self, converter):
    ...
    def test_get_entry_id_with_single_id(self, converter):
    ...
    def test_get_entry_id_with_no_id(self, converter):
    ...
    def test_create_intervention_reference_as_service_request(self, converter):
    ...
    def test_create_intervention_reference_as_procedure(self, converter):
    ...
    def test_create_intervention_reference_not_found(self, converter):
    ...
    def test_create_outcome_reference_found_in_registry(self, converter):
    ...
    def test_create_outcome_reference_not_found(self, converter):
    ...
    def test_create_outcome_reference_without_registry(self):
    ...
    def test_empty_interventions_list(self, converter):
        """Test empty interventions list returns empty activities."""
        activities = converter._link_outcomes_to_activities([], [])
        assert activities == []

    def test_empty_outcomes_list_with_interventions(self, converter):
