...
def verify_fhir_r4b_compliance():
    ...
    assert "recorder" in R4BCondition.model_fields, "Condition.recorder must exist in FHIR R4B"
    ...
    assert "recorder" in R4BProcedure.model_fields, "Procedure.recorder must exist in FHIR R4B"
