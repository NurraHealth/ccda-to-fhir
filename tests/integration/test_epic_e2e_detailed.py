...
class TestEpicDetailedValidation:
    ...
    def test_observation_interpretation_exact(self, epic_bundle):
    ...
    def test_observation_reference_range_ucum_exact(self, epic_bundle):
    ...
    def test_patient_race_extension_exact_structure(self, epic_bundle):
    ...
    def test_procedure_datetime_timezone_exact(self, epic_bundle):
