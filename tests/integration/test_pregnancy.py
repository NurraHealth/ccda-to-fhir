...
class TestPregnancyObservation:
    ...
    def test_converts_pregnancy_status_code(self, ccda_pregnancy: str) -> None:
    ...
    def test_converts_pregnancy_value(self, ccda_pregnancy: str) -> None:
    ...
    def test_category_is_social_history(self, ccda_pregnancy: str) -> None:
    ...
    def test_converts_estimated_delivery_date(self, ccda_pregnancy: str) -> None:
    ...
    def test_converts_effective_datetime(self, ccda_pregnancy: str) -> None:
    ...
    def test_converts_identifier(self, ccda_pregnancy: str) -> None:
    ...
    def test_resource_type_is_observation(self, ccda_pregnancy: str) -> None:
    ...
    def test_has_subject_reference(self, ccda_pregnancy: str) -> None:
...
class TestPregnancyWithoutEDD:
    ...
    def test_pregnancy_without_edd_component(self, ccda_pregnancy_no_edd: str) -> None:
...
class TestPregnancyCodeVariants:
    ...
    def test_pregnancy_with_loinc_code(self, ccda_pregnancy_loinc: str) -> None:
...
class TestPregnancyGestationalAge:
    ...
    def test_pregnancy_with_gestational_age_component(
        ...
        ccda_doc = wrap_in_ccda_document(
            ccda_pregnancy_with_gestational_age, SOCIAL_HISTORY_TEMPLATE_ID
        )
        bundle = convert_document(ccda_doc)["bundle"]
    ...
    def test_gestational_age_different_loinc_codes(
        ...
        modified_ccda = ccda_pregnancy_with_gestational_age.replace(
            'code code="49051-6"', 'code code="11885-1"'
        ).replace(
...
class TestPregnancyLastMenstrualPeriod:
    ...
    def test_pregnancy_with_lmp_component(self, ccda_pregnancy_with_lmp: str) -> None:
...
class TestPregnancyComprehensive:
    ...
    def test_pregnancy_with_all_components(self, ccda_pregnancy_comprehensive: str) -> None:
        ...
        component_codes = {comp["code"]["coding"][0]["code"] for comp in observation["component"]}
    ...
    def test_comprehensive_component_values(self, ccda_pregnancy_comprehensive: str) -> None:
        ...
        components = {comp["code"]["coding"][0]["code"]: comp for comp in observation["component"]}
